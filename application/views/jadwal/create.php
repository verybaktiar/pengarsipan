							...
							<div class="col-md-12">
								...
								<form action="" method="post">
									...
									<div class="form-group">
										...
										<input type="text" name="sasaran" placeholder="sasaran" id="sasaran" class="form-control">
									</div>
									<div class="form-group">
										<label for="">waktu</label>
										<input type="text" name="waktu" placeholder="waktu" id="waktu" class="form-control">
									</div>
									<div class="form-group">
