  ...
  <div class="col-12 table-responsive">
    <table class="table table-white bg-white table-bordered" width="60%" cellpadding="10" cellspacing="0">
      <thead>
        <tr>
        <th colspan="3">
            <img src="<?php echo base_url('vendor/') ?>img/logo.png" alt="logo.png" width="150" height="150" style="float: left; margin-left: 80px; ">
            <center><h1>Lembar Disposisi<br>BKR Anggrek <br></h1>
              <span class="text-muted">Jl. Ahmad Yhani, Dusun Muning,Desa Grobogan Rt.05/Rw.3 Kecamatan.Jiwan Kabupaten Madiun Jawa Timur Kode Pos:63161</span></center>
          </th>
        </tr>
      </thead>
      <tbody>
